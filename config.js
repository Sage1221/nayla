...
global.mods = ['62895334155794'] // Want some help?
global.prems = JSON.parse(fs.readFileSync('./src/premium.json')) // Premium user has unlimited limit
global.DeveloperMode = 'false' // true or false
global.linkGC = ['https://chat.whatsapp.com/EDiKN5sOBszIdMTqugwvDZ']
global.packname = 'Sage-Bot'
global.author = 'Sage'
global.multiplier = 36 // The higher, The harder levelup
global.sessionName = 'sage' // The Session name behind the .json example is nayla.json
global.mesreport = 50
global.botname = 'Sage-Bot'
